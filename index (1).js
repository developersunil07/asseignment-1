var outsideClick = function (e) {
   ...
   if (!container.preventDefault(e.target) && container.has(e.target).length === 0 && container.is(':visible')) {
...
$(document).ready(function () {
   ...
   let clicked = document.getElementsByClassName(".custmonDropDwon");
   ...
   let basic_banner = document.querySelectorAll(".basic_banner_read_btn")

   basic_banner.addEventListener('click', function () {

      if (basic_banner_read_btn == false) {
         $(this).text("Read Less");
         basic_banner.slideToggle(500);
   ...
   let filterToggel = document.querySelectorAll(".filterToggel")
   ...
   let customPopup = document.querySelectorAll(".customPopup");
   let commonPopup = document.querySelectorAll(".commonPopup");
   ...
   let mainTable = document.querySelectorAll(".mainTable");

   mainTable.addEventListener('Onscroll', function (e) {

      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.getElementsByClassName(".ListingTable th:nth-child(3), td:nth-child(3)").classList.add("before");
      } else {
         document.getElementsByClassName(".ListingTable th:nth-child(3), td:nth-child(3)").classList.remove("before");
      }
   ...
   let currenciesTable = document.querySelectorAll(".currenciesTable");
   let exchangeTable = document.querySelectorAll(".exchangeTable");

   currenciesTable.addEventListener('Onscroll', function (e) {

      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.getElementsByClassName(".ListingTable th:nth-child(2), td:nth-child(2)").classList.add("before");
      } else {
         document.getElementsByClassName(".ListingTable th:nth-child(2), td:nth-child(2)").classList.remove("before");
      }

   })

   exchangeTable.addEventListener('Onscroll', function (e) {
   ...
   let historical_data = document.querySelectorAll(".historical-data");

   historical_data.addEventListener('Onscroll', function (e) {
      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.getElementsByClassName(".ListingTable th:nth-child(1), td:nth-child(1)").classList.add("before");
      } else {
         document.getElementsByClassName(".ListingTable th:nth-child(1), td:nth-child(1)").classList.remove("before");
      }
   ...
   let financialTable = document.querySelectorAll(".financialTable");

   financialTable.addEventListener('Onscroll', function (e) {
      let isScroll = e.currentTarget.scrollLeft;
      if (isScroll) {
         document.getElementsByClassName(".ListingTable th:nth-child(1), td:nth-child(1)").classList.add("before");
      } else {
   ...
   let header_for_mobile = document.querySelectorAll(".header-for-mobile");
   let searchPopup = document.querySelectorAll(".searchPopup");
   let searchpopupHider = document.querySelectorAll(".searchpopupHider")

   // All events

   header_for_mobile.addEventListener('click' , function(){
      document.querySelectorAll(body).style.overflow = "hidden";
      document.querySelectorAll(".searchDiv-for-mb").classList.add("active")
   })
   ...
   searchpopupHider.addEventListener('click' , function(){
      document.querySelectorAll(body).style.overflow = "auto";
      document.querySelectorAll(".searchDiv-for-mb").classList.remove("active")
   })
   ...
   $(function () {
      $(window).scroll(function () {
         ...
         if (scrolled > 200) $(".gototopIconDiv").fadeIn("slow");
         if (scrolled < 200) $(".gototopIconDiv").fadeOut("slow");
      });

      $(".gototopIconDiv").click(function () {
         $("html, body").animate({
            scrollTop: "0",
         },
            500
   ...
   let popupRemover = document.querySelectorAll(".popupRemover");

   popupRemover.addEventListener('click' ,function(){
      document.getElementById("#LoginBox").classList.remove("active")
      document.getElementsById("#signUpBox").classList.remove("active")
   ...
   let isHighLight = document.getElementById("#HighlightsBox");

   isHighLight.addEventListener('click' ,function(){
      document.getElementsByClassName(".Banner_cards").slideToggle(100);

   });
   
   // click(function () {
   //    $(".Banner_cards").slideToggle(100);
   // });
});
...
// == == == faq scripts == == == //
$(".faqAcc .flexAccHead").click(function () {
   let AccHeadObj = $(this);
